...
export const projectsData: Project[] = [
  {
    ...
    image: "/yoga-app-interface.png",
    gallery: [
      "/yoga-app-interface.png",
      "/placeholder.svg?height=400&width=600&text=YogaApp+Dashboard",
      "/placeholder.svg?height=400&width=600&text=YogaApp+Booking",
      "/placeholder.svg?height=400&width=600&text=YogaApp+Profile",
    ],
    challenges: [
  ...
  },
  {
    ...
    status: "Private Repository",
    image: "/video-chat-social-platform.png",
    gallery: [
      "/video-chat-social-platform.png",
      "/placeholder.svg?height=400&width=600&text=ReConnect+Matching",
      "/placeholder.svg?height=400&width=600&text=ReConnect+Chat",
      "/placeholder.svg?height=400&width=600&text=ReConnect+Profile",
    ],
    challenges: [
  ...
  },
  {
    ...
    status: "MIT License",
    license: "MIT",
    image: "/placeholder-mtolu.png",
    gallery: [
      "/placeholder-mtolu.png",
      "/placeholder.svg?height=400&width=600&text=PaisaPilot+Dashboard",
      "/placeholder.svg?height=400&width=600&text=PaisaPilot+Analytics",
      "/placeholder.svg?height=400&width=600&text=PaisaPilot+Budget",
    ],
  ...
  },
  {
    ...
    status: "MIT License",
    license: "MIT",
    image: "/placeholder-zprtw.png",
    gallery: [
      "/placeholder-zprtw.png",
      "/placeholder.svg?height=400&width=600&text=AstroApp+Horoscope",
      "/placeholder.svg?height=400&width=600&text=AstroApp+Chart",
      "/placeholder.svg?height=400&width=600&text=AstroApp+Compatibility",
    ],
  ...
  },
  {
    ...
    status: "MIT License",
    license: "MIT",
    image: "/placeholder-d57fn.png",
    gallery: [
      "/placeholder-d57fn.png",
      "/placeholder.svg?height=400&width=600&text=SuggestKaro+Search",
      "/placeholder.svg?height=400&width=600&text=SuggestKaro+Compare",
      "/placeholder.svg?height=400&width=600&text=SuggestKaro+Deals",
    ],
  ...
  },
  {
    ...
    status: "MIT License",
    license: "MIT",
    image: "/quiz-platform-interface.png",
    gallery: [
      "/quiz-platform-interface.png",
      "/placeholder.svg?height=400&width=600&text=Quiztrix+Creator",
      "/placeholder.svg?height=400&width=600&text=Quiztrix+Game",
      "/placeholder.svg?height=400&width=600&text=Quiztrix+Analytics",
    ],
